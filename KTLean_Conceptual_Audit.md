...
| `GlyphSpectralTriadicEngine.lean` | Verifies ternary-state system generating coordinate three-planes. | Standard Model gauge symmetry $(SU(3) \text{time}s SU(2) \text{time}s U(1))$ from 3D packing. | Derivation of exactly **3 fundamental fermion generations** from $S_5 \to SU(5)$ Galois mapping. |
