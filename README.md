...
* **[Mathematical_Proof_Gödel.md](Mathematical_Proof_Gödel.md)**: Formal mathematical proofs compiling the logic of the Circular Theory and the Gödelian limits of internal measurement.
