...
* **[software/](software/)**: Software engines, simulations, and interactive computing environments:
  * **[software/active_inference/fep_ego_awareness_sim.py](software/active_inference/fep_ego_awareness_sim.py)**: Active Inference simulation engine modeling the Dualist Engine (Ego Y+ sampling vs. Awareness Y- auditing) under Friston’s Free Energy Principle.
  * **[software/notebooks/Process_Ontology_Hypergraph_Studio.ipynb](software/notebooks/Process_Ontology_Hypergraph_Studio.ipynb)**: Interactive Jupyter notebook and D3.js force-directed hypergraph visualization studio. An interactive Jupyter Notebook and D3.js force-directed hypergraph visualization studio. Allows interactive drag-and-drop network exploration, node filtering, and dynamic RAG concept inspection of Process Ontology invariants ($\phi, P, \sigma=1/2, L\_{12}, \delta\_{\text{slip}}, \Omega$).
